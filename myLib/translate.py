...
class Translation:
    ...
    def post(self, text):
        ...
        salt = str(uuid.uuid1())
        signStr = self.APP_KEY + self.truncate(
            text) + salt + curtime + self.APP_SECRET
...
if __name__ == '__main__':
    a = Translation()
    x = a.translate("DeprecationWarning: the imp module is deprecated in favour of importlib; see the module's documentation for alternative uses")
    print(x, type(x))
